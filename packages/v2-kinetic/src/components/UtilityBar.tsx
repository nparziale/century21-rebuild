    ...
    >
      <div className="mx-auto flex h-10 max-w-[var(--container-max)] items-center justify-between px-4 md:px-6">
        <div className="flex items-center gap-2 text-white/95">
          ...
          <span className="hidden sm:inline text-white/95">Desde 2017 en Argentina</span>
        </div>
        <div className="flex items-center gap-3 md:gap-5">
          <a
            href="https://21online.century21.com"
            className="v2-tap hidden sm:inline-flex items-center gap-1.5 text-white/95 hover:text-white"
