    ...
    <section data-section="newsletter" className="zone-blue py-14 md:py-20">
      <div className="mx-auto grid max-w-[var(--container-max)] grid-cols-1 gap-8 px-4 md:px-6 lg:grid-cols-[1.2fr_1fr] lg:items-end">
        <div>
          ...
          <p className="mt-3 text-[0.95rem] text-white/95">
        ...
        >
          <label className="relative flex-1">
            ...
            <input
              ...
              className="w-full border border-white/30 bg-transparent px-4 py-3.5 text-white placeholder:text-white/95 outline-none transition-[transform,border-color] focus:-translate-y-[2px] focus:border-white"
            />
          </label>
          <button
            type="submit"
